...
const TvFeedTile = {
    ...
    setup(props, { emit }) {
        ...
        const markUpNext = async () => {
           emit("markupnext", { MId: props.tv.MId, Name: props.tv.Name, Year: props.tv.Year, S: props.tv.UpNextS, E: props.tv.UpNextE })
    ...
    <div class="row">
        ...
        <div class="col">
            ...
            <p class="card-text text-end">
                Up Next : 
                <button :disabled="loading" @click="markUpNext" type="button" class="btn btn-outline-primary position-relative">
                    <span class="me-2">
                    {{ upNext }}
                    </span>
